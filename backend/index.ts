...
app.post('/api', async function(req: Request, res: Response) {
    ...
    if (validationErrors.length == 0) {
        const responseBody: ResponseBody = {message: "Hello, " + body.name + "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAa"};
